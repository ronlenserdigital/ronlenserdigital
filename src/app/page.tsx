...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="bg-transparent relative">
      ...
      {/* Hero Section */}
      <section className="relative z-10 min-h-screen flex flex-col items-center pt-24 pb-8 overflow-hidden">
        ...
        {/* Scroll Indicator */}
        <motion.div
          className="flex flex-col items-center gap-2 text-neutral-500 text-sm shrink-0 relative z-20 mt-12"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
